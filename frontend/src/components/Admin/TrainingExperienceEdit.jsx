...
${
  activeTab === "Professional Memberships"
    ...
    : "text-gray-700 hover:text-gray-900"
                ...
                <div className="mx-auto ">
                  <form className="space-y-6">
                    <div className="bg-white rounded-lg shadow-md p-6">
                      ...
                      <div>
                        <label className="block lg:text-[18px] text-[16px] font-[700] mb-2">
                          Concise Description of Work Carried Out : *
                        </label>
                        <textarea
                          className="lg:w-[705px] w-full px-3 lg:text-[16px] text-[14px] font-[400] py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          rows="3"
                          defaultValue="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labor"
                        />
                      </div>
        ...
        <div className=" hidden -mt-36 mb-24">
          <div className="mx-auto lg:p-6  lg:bg-[#EDEDED] ">
            <div className="mx-auto ">
              <form className="space-y-6">
                <div className="bg-white p-6 shadow-md  ">
                  <div className="">
                    ...
                    <div className="flex justify-end">
                      <button
                        type="button"
                        onClick={addMoreEntry}
                        className="mt-2 px-4 py-2 bg-[#356CC4] mb-5 lg:text-[18px] text-[16px] font-[700]  text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                        + Add more
                      </button>
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      className="lg:w-[705px] w-full px-3 lg:text-[16px] text-[12px] font-[400] py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      rows="3"
                      defaultValue="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labor"
                    />
                  </div>
  ...
  activeTab === "Professional Memberships"
    ...
    : "text-gray-700 hover:text-gray-900"
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          onClick={handleBrowseClick}
                          className="bg-[#2A3990] text-[18px] font-[700] text-white px-6 py-2 rounded hover:bg-[#1b2142] transition-colors"
                        >
                          Browse...
                        </button>
                      </div>
      ...
      <div className="bg-[#D9D9D9]">
        <div className=" lg:hidden -mt-36 mb-24">
          <div className="mx-auto lg:p-6  lg:bg-[#EDEDED] ">
            <div className="mx-auto ">
              <form className="space-y-6">
                <div className="bg-white p-6 shadow-md  ">
...
export default TrainingExperienceEdit;
