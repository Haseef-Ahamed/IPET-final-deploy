  ...
  const handleNext = () => {
    const updatedData = {
      ...
      professionalMemberships: {
        // Add your professional memberships fields here
        memberships: [
          {
    ...
    activeTab === "Professional Memberships"
      ...
      : "text-gray-700 hover:text-gray-900"
                ...
                <div className="hidden">
                  <button
                    onClick={() => navigate("/memberships-edit")}
          ...
          <div className="bg-[#EDEDED] lg:p-6 shadow-sm ">
            <div className="lg:bg-white lg:p-6 rounded-lg">
              <h2 className="text-[18px] font-[700] mb-6">
                Period Of Work : *
              </h2>

              <div className="bg-white lg:p-0 p-6 grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div>
                  <h3 className="lg:text-[18px] text-[16px] font-[700] mb-2">
                    Institution
                  </h3>
            ...
            {/* <div className="flex justify-end gap-4 mt-6">
              <button
                ...
                className="lg:w-[227px] w-full px-[17px] py-[8px] lg:text-[18px] text-[16px] font-[700] rounded bg-[#2A3990] text-white"
              >
                Back
              </button>
            </div> */}
        ...
        <div className="max-w-1500 mx-auto space-y-6 -mt-10 mb-32 lg:px-16 px-0 hidden">
          <div className="flex flex-col  lg:bg-[#D9D9D9] bg-white md:px-0 py-6 px-6">
            {/* Approve Section */}
            <div className=" ">
