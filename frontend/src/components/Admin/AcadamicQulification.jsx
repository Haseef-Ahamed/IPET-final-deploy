...
const AcadamicQulification = () => {
  const [activeTab, setActiveTab] = useState("Academic Qualifications");
  const [didntCompleteAL, setDidntCompleteAL] = useState(false);
  ...
  const handleNext = () => {
    // Combine existing data with academic qualifications
    const updatedData = {
      ...userData,
      academicQualifications: {
        // Add your academic qualification fields here
        qualifications: [
          // Example structure
          {
    ...
    // Navigate to training experiences with updated data
    navigate("/training", {
      state: {
        userData: updatedData
        // state: {
        //   userData: userData // Make sure you're passing the user data
        // }
      }
    });
  };
  ...
  return (
    <>
      <div className="bg-[#D9D9D9]  lg:py-6 py-6 lg:px-0 px-6 hidden">
        <div className="w-full bg-white shadow-md  lg:px-16 px-6 lg:py-6 py-6 mb-2">
          <div className="flex flex-col md:flex-row items-center md:items-center ">
            ...
            <div className="flex-1 w-full space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4   p-2 gap-[6px] max-w-[1215px] lg:ml-[30px]">
                <div className="flex flex-col md:flex-row gap-4">
                  <span className="font-[400] lg:text-[18px] text-[12px]">
                    Wild Apricot ID :
                  </span>
        ...
        {/* <div className="max-w-[1360px] mx-auto  lg:bg-white lg:px-12 py-6  mb-28">
  ...
  ${
    activeTab === "Professional Memberships"
      ...
      : "text-gray-700 hover:text-gray-900"
                ...
                <div className="lg:block hidden">
                  <button onClick={()=>navigate("/acadamic-edit")} className="flex items-center gap-4 px-4 py-2 rounded-md bg-[#4287F5] text-[18px] font-[400] text-white hover:bg-blue-600 transition-colors ml-4">
                    <svg
                      width="26"
                      height="23"
                      viewBox="0 0 26 23"
          ...
          <div className="lg:hidden flex justify-end -mt-5 mb-10">
            <button onClick={()=>navigate("/acadamic-edit")}  className="flex items-center gap-4 px-4 py-2 rounded-md bg-[#4287F5] lg:text-[18px] text-[12px] font-[400] text-white hover:bg-blue-600 transition-colors ml-4">
              <svg
                width="26"
                height="23"
                viewBox="0 0 26 23"
          ...
          <div className="lg:bg-[#EDEDED] lg:p-6  lg:shadow-sm">
            <div className="space-y-6  ">
              
              <div className=" lg:bg-white lg:p-12 rounded-[10px]">
                <h2 className="text-[18px] font-[700] mb-4">
                  GCE Advanced Level:
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block lg:text-[18px] text-[14px] font-[700] mb-1">
                      Examination: *
                    </label>
                    <input
                      type="text"
                      defaultValue="GCE Advanced Level"
                      className="lg:block hidden  w-full text-[14px] font-[400] border rounded-md px-3 py-2"
                    />
                    <p className="border-2 border-black p-2 lg:hidden">
                      GCE Advanced Level
                    </p>
                  </div>
                  <div>
                    ...
                    <input
                      type="text"
                      defaultValue="2017"
                      className="lg:block hidden w-full border text-[14px] font-[400] rounded-md px-3 py-2"
                    />
                    2017
                  </div>

                  <div className="mt-6 lg:hidden">
                    <h2 className="lg:text-[18px] text-[14px]  font-[700] mb-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button className="bg-[#2A3990] lg:block hidden text-[18px] font-[700]  text-white px-6 py-2 rounded hover:bg-[#1b2142] transition-colors">
                        Browse...
                      </button>
                    </div>
                  </div>
                ...
                <div className="max-w-2xl mx-auto p-6 lg:mt-0 mt-5 bg-white lg:rounded-lg lg:hidden shadow">
                  {subject.map((item, index) => (
                    <div key={index} className="mb-6 last:mb-0">
                      <div className="mb-2">
                        <label className="lg:text-[18px] text-[14px]  text-gray-700">
                          Subject : *
                        </label>
                      ...
                      <div>
                        ...
                        <div className="mt-1 lg:text-[18px] text-[14px] ">
                          <div className="text-gray-900">{item.credit}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className=" max-w-2xl mt-4">
                  <div className="mb-8 lg:block hidden">
                    <div className="flex justify-between mb-4">
                      <h2 className="text-[18px] font-[700]">Subjects : *</h2>
                      <h2 className="text-[18px] font-[700]">Credits : *</h2>
                    </div>
                    ...
                    {subjects.map((subject, index) => (
                      ...
                      >
                        <span className="text-[18px] font-[300] text-gray-700">
                          {subject.name}
                        </span>
                        <span className="text-[18px] font-[300] text-gray-700">
                          {subject.grade}
                  ...
                  <div className="lg:hidden lg:mt-4 lg:mb-0 mb-10">
                    <label className="flex items-center font-bold  space-x-2">
                      <input
                        type="checkbox"
                        checked={didntCompleteAL}
                        onChange={(e) => setDidntCompleteAL(e.target.checked)}
                        className="rounded"
                      />
              ...
              <div className="pt-6 bg-white lg:p-10 p-8 lg:rounded-[10px]">
                <h2 className="lg:text-[18px] text-[14px]  font-[700] mb-4">
                  Higher Education :
                </h2>
                ...
                <div className="flex gap-6">
                  ...
                  <div className="p-2 lg:p-0">
                    <p className="lg:text-[18px] text-[14px]  font-[700]">
                      Period Of Study : *
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-44 mt-2">
                      <div>
                        <p className="lg:text-[18px] text-[14px]  font-[700]">
                          From: *
                        </p>
                        <p className="lg:text-[18px] text-[14px]  font-[400] text-gray-600">
                          2018
                        </p>
                      </div>
                      <div className="flex items-center justify-between lg:gap-64 gap-12">
                        <div>
                          <p className="lg:text-[18px] text-[14px]  font-[700]">
                            To : *
                          </p>
                        ...
                        <div className="flex items-center space-x-2 lg:block hidden">
                          <input
                            type="checkbox"
                            className="w-5 h-5 border-gray-300 focus:ring-2 focus:ring-blue-400"
                          />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 lg:p-0 p-2">
                  <div>
                    <p className="lg:text-[18px] text-[14px]  font-[700]">
                      Name Of Institution : *
                    </p>
                    <p className="lg:text-[18px] text-[14px]  font-[400] text-gray-600 mt-1">
                      abc College
                    </p>
                  </div>
                ...
                <div className="lg:block hidden">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div>
                      ...
                      <p className="text-[18px] font-[400] text-gray-600 mt-1">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex gap-3">
                      <div className="flex items-center bg-[#D9D9D9] px-4 py-2 rounded">
                        <span className="text-[12px] font-[700] text-gray-700">
                          AL.pdf
                        </span>
                        <span className="ml-2">
              ...
              <div className="flex items-center space-x-2 lg:hidden">
                <input
                  ...
                  className="w-5 h-5 border-gray-300 focus:ring-2 focus:ring-blue-400"
                />
                <label className="lg:text-[18px] text-[14px]  font-[700]">
                  Ongoing
                </label>
              </div>

              <div className="lg:hidden bg-white p-4 lg:rounded-md">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                  <div>
                    <p className="lg:text-[18px] text-[16px]  font-[700]">
                      Name Of Qualification : *
                    </p>
                    <p className="lg:text-[18px] text-[14px]  font-[400] text-gray-600 mt-1">
                      Bachelor of Science in Information Technology (BSc IT)
                ...
                <div className="mt-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button className="hidden bg-[#2A3990] text-[18px] font-[700]  text-white px-6 py-2 rounded hover:bg-[#1b2142] transition-colors">
                      Browse...
                    </button>
                  </div>
                </div>
            ...
            <div className="flex justify-end gap-4 mt-6  lg:mb-2 mb-6  flex-col sm:flex-row  sm:gap-2">
            <button
              onClick={() => navigate("/personal")}
              className="lg:w-[227px] px-[17px] py-[8px] lg:text-[18px] text-[16px] font-[700] rounded bg-[#2A3990] text-white"
            >
              Back
            </button>
            <button
          ...
          <div className="lg:absolute lg:hidden bottom-0 -mt-4  left-0 w-full h-[7px] bg-[#2A3990]">
            {" "}
          </div>
        </div> */}
      </div>
      ...
      <div className="bg-[#D9D9D9]  lg:py-1 py-6 lg:px-16 px-6">
        <div className="max-w-[1360px] mx-auto  lg:bg-white lg:px-14 lg:py-6 py-6  mb-28">
          {/* Navigation Tabs */}
    ...
    activeTab === "Professional Memberships"
      ...
      : "text-gray-700 hover:text-gray-900"
                ...
                <div className="hidden">
                  <button
                    onClick={() => navigate("/acadamic-edit")}
              ...
              <div className=" lg:bg-white lg:p-12 rounded-[10px]">
                ...
                <div className=" max-w-2xl mt-4">
                  ...
                  <div className="mt-6 lg:block hidden">
                    ...
                    <div className="flex gap-3">
                      {selectedFile && (
                        <div className="flex items-center bg-gray-200 px-4 py-2 rounded group">
                          <span className="text-[12px] font-[700] text-gray-700">
                            {selectedFile.name}
                          </span>
                  ...
                  />
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="bg-[#2A3990] text-[18px] font-[700] text-white px-6 py-2 rounded hover:bg-[#1b2142] transition-colors focus:outline-none focus:ring-2 focus:ring-[#2A3990] focus:ring-opacity-50"
                        >
                          Browse...
                        </button>
                      </div>
...
export default AcadamicQulification;
