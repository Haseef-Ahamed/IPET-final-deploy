...
const TrainingAndExperience = () => {
  ...
  const workHistory = [
    {
      from: "2021",
      to: "2022",
      place: "abc company pvt",
      position: "Project Manager",
    },
    {
      from: "2023",
      to: "2024",
      place: "LOC company pvt",
      position: "Project Manager",
    },
  ];
  ...
  const handleNext = () => {
    const updatedData = {
      ...userData,
      trainingExperiences: {
        // Add your training experiences fields here
        experiences: [
          {
  ...
  ${
    activeTab === "Professional Memberships"
      ...
      : "text-gray-700 hover:text-gray-900"
                ...
                <div className="lg:block hidden">
                  <button onClick={()=>navigate("/training-edit")} className="flex items-center gap-4 px-4 py-2 rounded-md bg-[#4287F5] text-[18px] font-[400] text-white hover:bg-blue-600 transition-colors ml-4">
                    <svg
                      width="26"
                      height="23"
                      viewBox="0 0 26 23"
          ...
          <div className="lg:hidden flex justify-end -mt-5 mb-10">
            <button onClick={()=>navigate("/training-edit")} className="flex items-center gap-4 px-4 py-2 rounded-md bg-[#4287F5] lg:text-[18px] text-[12px] font-[400] text-white hover:bg-blue-600 transition-colors ml-4">
              <svg
                width="26"
                height="23"
                viewBox="0 0 26 23"
          ...
          <div className="lg:bg-[#EDEDED] lg:p-6 lg:shadow-sm">
            <div className="bg-white lg:p-6 p-4 lg:rounded-lg">
              <h2 className="text-[18px] font-[700] mb-6">
                Period Of Work : *
              </h2>
              ...
              {workHistory.map((work, index) => (
                <div
                  key={index}
                  className="grid grid-cols-1 md:grid-cols-4 gap-4  lg:mb-4 -mb-6 lg:p-0 p-4"
                >
                  <div>
                    <label className="lg:text-[18px] text-[16px] font-[700] block mb-2">
                      From: *
                    </label>
                    {work.from}
                  </div>
              ...
              <div className="lg:block hidden">
                <div className="mt-8">
                  ...
                  <div className="max-w-[745px]">
                    <p className="text-[18px] p-4 text-black font-[400] max-w-[707px] border border-black">
            ...
            <div className="lg:hidden  p-4 mt-5 rounded-md">
                <div className="mt-8">
                  ...
                  <div className="max-w-[745px]">
                    <p className="lg:text-[18px] text-[14px] p-4 text-black font-[400] max-w-[707px] border border-black">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                      sed do eiusmod tempor incididunt ut labore et dolore magna
                      aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                      ullamco labor
                ...
                <div className="mt-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button className="lg:block hidden bg-[#2A3990] text-[18px] font-[700]  text-white px-6 py-2 rounded hover:bg-[#1b2142] transition-colors">
                      Browse...
                    </button>
                  </div>
                </div>
            ...
            <div className="bg-white lg:p-6 p-4 lg:rounded-lg">
              ...
              <div className="lg:block hidden">
                <div className="mt-8">
                  ...
                  {/* <textarea
                  className="w-full border p-4 rounded min-h-[100px]"
                  value="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labor"
                  readOnly
                /> */}
                  <div className="max-w-[745px]">
                    <p className="text-[18px] p-4 text-black font-[400] max-w-[707px] border border-black">
