    ...
    if (userId) {
      const fetchUserDetails = async () => {
        try {
          ...
          if (data.higher_education_institutes) {
            data.higher_education_institutes = JSON.parse(data.higher_education_institutes);
          }
  ...
  return (
    <>
      ...
      <div className="pt-6 bg-white lg:p-10 p-8 lg:rounded-[10px]">
        ...
        {/* Render Higher Education Institutes */}
        {userData?.higher_education_institutes &&
          userData.higher_education_institutes.map((institute, index) => (
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside">
                    {institute.qualifications.map((qualification, idx) => (
                      <li key={idx} className="lg:text-[18px] text-[14px] font-[400] text-gray-600">
                        {qualification.name} ({qualification.awardedYear})
                      </li>
                    ))}
                  </ul>
                </div>
