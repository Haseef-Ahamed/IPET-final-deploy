...
const AcadamicQulificationEdit = () => {
  ...
  const [subjects, setSubjects] = useState([
    { subject: "Combined Mathematics", credit: "A" },
    { subject: "Physics", credit: "A" },
    { subject: "Chemistry", credit: "A" },
    { subject: "English", credit: "A" },
  ]);
                ...
                <form className="space-y-8">
                  ...
                  <div className="bg-white p-6 rounded-md">
                    <div className="space-y-4">
                      <h2 className="lg:text-[18px] text-[16px] font-[700]">
                        GCE Advanced Level:
                      </h2>

                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <label className="lg:text-[18px] text-[16px] font-[700]">
                            Examination: *
                          </label>
                          <select className="mt-1 block w-full lg:text-[16px] text-[14px] font-[400] border border-black  px-3 py-2">
                            <option>GCE Advanced Level</option>
                          </select>
                        </div>
                        <div>
                          <label className="block lg:text-[18px] text-[16px] font-[700]">
                            Year: *
                          </label>
                          <input
                            type="text"
                            className="mt-1 block w-full border border-black lg:text-[16px] text-[14px] font-[400] px-3 py-2"
                            defaultValue="2017"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="space-y-2">
                            ...
                            <select className="block w-full lg:text-[16px] text-[14px] font-[400] border border-black px-3 py-2">
                      ...
                      <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 items-center">
                          <div>
                            ...
                            <input
                              type="text"
                              className="mt-1 block w-full lg:text-[16px] text-[14px] font-[400]  border border-black px-3 py-2"
                              defaultValue="2018"
                            />
                          </div>
                          <div>
                            ...
                            <div className="flex items-center gap-4">
                              <input
                                type="text"
                                className="mt-1 block lg:w-[290px] w-full lg:text-[16px] text-[14px] font-[400] border border-black px-3 py-2"
                                defaultValue="2020"
                              />
                              <label className="flex items-center gap-2">
                                ...
                                />
                                <span className="lg:text-[18px] text-[16px] font-[700]">
                                  Ongoing
                                </span>
                              </label>
                            </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            type="text"
                            className="mt-1 block w-full lg:text-[16px] text-[14px] font-[400] border border-black px-3 py-2"
                            defaultValue="Bachelor of Science in Information Technology (BSc IT)"
                          />
                        </div>
                        <div>
                          <label className="block lg:text-[18px] text-[16px] font-[700]">
          ...
          <div className="mx-auto lg:p-6 lg:bg-[#EDEDED] ">
            <div className="mx-auto ">
              <form className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mt-6 lg:hidden">
                      ...
                      <div className="flex lg:flex-row flex-col gap-3">
                        <div className="flex items-center bg-gray-200 px-9 py-2 lg:w-[132px] w-[132px] rounded">
                          <span className="text-[12px] font-[700] text-gray-700">
                            AL.pdf
                          </span>
                          <span className="ml-2">
                    ...
                    <div className="lg:hidden space-y-4">
                      ...
                      <button
                        ...
                        className="w-full py-3 lg:text-[18px] text-[16px] font-[700]  bg-[#2A3990] text-white rounded-md hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                        + Add more Subjects
                      </button>
                      ...
                      <div className="flex items-center gap-2 mt-4">
                        ...
                        <label
                          ...
                          className="lg:text-[18px] text-[16px] font-[700]"
                        >
                          Didn't Complete A/L
                        </label>
                      </div>
                ...
                {/* Higher Education Section */}
                <div className="bg-white p-6 rounded-md lg:block hidden">
                  <div className="space-y-8">
                    <h2 className="lg:text-[18px] text-[16px] font-[700]">
                      Higher Education:
                    </h2>
                ...
                <div className="rounded-md lg:hidden">
                  <div className="space-y-4">
                    <h2 className="lg:text-[18px] text-[16px] font-[700] px-6">
                      Higher Education:
                    </h2>
                    <div className="bg-white p-6 space-y-4">
                      <div className="">
                        ...
                        <div className="grid md:grid-cols-2 gap-3 items-center">
                          <div>
                            <label className="block lg:text-[18px] text-[16px] lg:font-[700] font-[500]">
                              From: *
                            </label>
                            <input
                              type="text"
                      ...
                      <div className="mt-6 lg:hidden">
                        ...
                        <div className="flex flex-col gap-3">
                          <div className="flex items-center bg-gray-200 px-9 py-2 w-[132px] rounded">
                            <span className="text-[12px] font-[700] text-gray-700">
                              AL.pdf
                            </span>
                            <span className="ml-2">
                          ...
                          <button className="bg-[#2D387D] text-[18px] font-[700]  text-white px-6 py-2 rounded hover:bg-[#1b2142] transition-colors">
                            Browse...
                          </button>
                        </div>
                      </div>
...
export default AcadamicQulificationEdit;
