        ...
        <div className="max-w-[1360px] mx-auto lg:bg-white lg:px-8 lg:py-6 py-4 rounded-lg">
          ...
          <div className="lg:bg-[#EDEDED] lg:p-6 p-4 rounded-lg lg:shadow-sm">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
              ...
              {/* Render Training & Experience Entries */}
              {userData?.training_experience?.length > 0 ? (
                userData.training_experience.map((work, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 p-4 sm:p-6 bg-gray-50 rounded-lg border border-gray-200"
                  >
                    <div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <p className="text-[14px] sm:text-[16px] p-3 bg-white border border-gray-300 rounded-md text-gray-900">
                        {work.workDescription || "No description provided"}
                      </p>
                    </div>
                    {work.trainingCertificatePath && (
                      <div className="sm:col-span-2">
                        <label className="text-[16px] font-[600] block mb-1 text-gray-700">
                          Certificate
                        </label>
                        <button
                          onClick={() => handleDownloadCertificate(work.trainingCertificatePath)}
                ...
                <p className="text-[16px] text-gray-600 text-center">
                  No training or experience entries available.
                </p>
              )}
