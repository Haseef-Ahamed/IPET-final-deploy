...
const Declineusers = () => {
  ...
  // Filter users to display only those with any admin status = "rejected"
  ...
  const currentUsers = rejectedUsers.slice(indexOfFirstItem, indexOfLastItem);
  const pageNumbers = [];
  for (let i = 1; i <= Math.ceil(rejectedUsers.length / itemsPerPage); i++) {
    pageNumbers.push(i);
  }
              ...
              {currentUsers.map((user, index) => (
                <tr key={index} className="hover:bg-gray-50 text-center">
                  ...
                  <td className="px-6 py-4 border-r">
                    <button
                      className={`px-4 py-1 rounded-md text-[14px] font-[600] transition-colors ${
                  ...
                  <td className="px-6 py-4 border-r">
                    ...
                    >
                      {capitalizeFirstLetter(user.admin3status)}
                    </button>
                  </td>
                  <td className="px-6 py-4 border-r">
                    <button
                    ...
                    >
                      {capitalizeFirstLetter(user.admin4status)}
                    </button>
                  </td>
                  <td className="px-6 py-4">
                    <button
                      onClick={() => handleViewInfo(user)}
                      className="bg-[#EB2929] hover:bg-red-500 text-white px-4 py-1 rounded-md text-[14px] font-[600] transition-colors"
                    >
                      View
                    </button>
                  </td>
          ...
          {currentUsers.map((user, index) => (
            ...
            >
              ...
              <div className="mt-4">
                <button
                  onClick={() => handleViewInfo(user)}
                  className="bg-[#EB2929] hover:bg-red-500 text-white px-4 py-2 rounded-md text-xs font-semibold w-full transition-colors"
                >
                  View
                </button>
              </div>
