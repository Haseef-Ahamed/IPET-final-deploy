...
const [userData, setUserData] = useState();
  ...
  const handleForwar = () => {
    ...
    // Update the user data with the selected admin
    const updatedUserData = {
      ...userData,
      admin: selectedAdmin,
    };

    // Navigate to ForwardedUsers with the updated user data
    navigate("/forward-users", {
      state: {
        forwardedUser: updatedUserData,
      },
    });
  };
...
//   };
  ...
  // const handleApprove = () => {
    ...
    //     // Navigate to forward-users with updated data
    //     navigate("/forward-users", {
    //       state: {
    //         updatedUserData: finalData,
    //         forwardSuccess: true
    ...
    useEffect(() => {
        ...
        if (!location.state?.updatedUserData) {
          // If no userData, redirect back to the previous page
          alert("No user data available. Redirecting back...");
      ...
      // Show loading or return null while checking userData
      if (!userData) {
        return null;
      }
    return (
    <>
      ...
      <div className="bg-[#D9D9D9]  lg:py-2 py-6 lg:px-16 px-6">
        ...
        <div className="max-w-[1500px] mx-auto bg-white  shadow-md p-6 space-y-8 mb-28">
          ...
          <p className="text-balck font-[500] text-sm md:text-[18px]">
