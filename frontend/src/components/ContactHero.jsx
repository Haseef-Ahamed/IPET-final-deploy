...
import about_bg from "../assets/Contactus_bg_n.svg";
import about_bg_m from "../assets/Contactus_bg_n.svg";
...
const ContactHero = () => {
  ...
  return (
    <>
    {/* <motion.div className="relative w-full h-[300px] md:h-[269px] sm:h-[390px] hidden md:block">
    ...
    <div className="relative w-full h-[169px] md:h-[269px] sm:h-[390px]  md:hidden">
      ...
      <div className="relative z-20 h-full max-w-7xl mx-auto sm:px-0 md:px-0 md:ml-[70px] sm:ml-[40px] ml-6">
        <div className="flex items-center h-full">
          ...
          >
            <motion.div className="absolute inset-0" variants={bgVariants}>
              <div className="absolute inset-0 bg-[#1a161699] z-10" />
              <motion.img
                src={about_bg}
                alt="About Us Hero"
                className="md:w-full sm:w-[740px] md:h-full sm:h-full object-cover object-[-0%,8%]"
                initial={{ scale: 1.1 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: false }}
