...
import newevent_bg from "../assets/NewsAndEvents_bg_n.svg";
import newevent_bg_m from "../assets/NewsAndEvents_bg_n.svg";
// import newevent_bg from "../assets/Abouthero_bg.svg";
// import newevent_bg_m from "../assets/Aboutus_m_bg.svg";

const NewsAndEventHero = () => {
    ...
    <>
      ...
      >
        <motion.div className="absolute inset-0" variants={bgVariants}>
          <div className="absolute inset-0 bg-[#36343499] z-10" />
          <motion.img
            src={newevent_bg}
            alt="About Us Hero"
            className="md:w-full sm:w-[740px] md:h-full sm:h-full object-cover object-[-0%,10%]"
            initial={{ scale: 1.1 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: false }}
...
export default NewsAndEventHero;
